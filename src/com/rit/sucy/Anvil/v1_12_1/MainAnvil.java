package com.rit.sucy.Anvil.v1_12_1;
...
public class MainAnvil implements AnvilView
{
    ...
    public String getNameText() {
        try {
            ...
            for (net.minecraft.server.v1_12_R1.ItemStack item : inv.getIngredientsInventory().getContents())
            {
            ...
            net.minecraft.server.v1_12_R1.ItemStack item = ((IInventory)g.get(anvil)).getItem(0);
            if (item == null)
                return null;
    ...
    public void setResultSlot(final ItemStack result) {
        plugin.getServer().getScheduler().runTask(plugin, new Runnable() {
            ...
            public void run() {
                ...
                ((CraftPlayer) player).getHandle().setContainerData(anvil, 0, anvil.levelCost);
            }
        });
    }
